...
typedef enum zend_enum_Gd_Heif_CompressionFormat {
	ZEND_ENUM_Gd_Heif_CompressionFormat_Hevc = 1,
	ZEND_ENUM_Gd_Heif_CompressionFormat_Av1 = 2,
} zend_enum_Gd_Heif_CompressionFormat;
#endif

#if defined(HAVE_GD_HEIF)
typedef enum zend_enum_Gd_Heif_ChromaSubsampling {
	ZEND_ENUM_Gd_Heif_ChromaSubsampling_Yuv420 = 1,
	ZEND_ENUM_Gd_Heif_ChromaSubsampling_Yuv422 = 2,
	ZEND_ENUM_Gd_Heif_ChromaSubsampling_Yuv444 = 3,
